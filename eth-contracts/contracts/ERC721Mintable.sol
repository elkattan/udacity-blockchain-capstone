...
contract Ownable {
    ...
    modifier onlyOwner() {
        require(msg.sender == _owner, "Sender must be the contract owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        ...
        require(msg.sender == tx.origin, "Sender must be a real contract");
...
contract ERC721 is Pausable, ERC165 {
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        require(originalOwner != to, "Owner cannot transfer token to himself");

        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(
            msg.sender == originalOwner ||
                isApprovedForAll(originalOwner, msg.sender),
            "Sender is not authorized to approve"
        );
        ...
        emit Approval(originalOwner, to, tokenId);
    }
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(to != zero, "Invalid address!");
    ...
    function _transferFrom(
        ...
        require(
            ...
            "The `from` address does not match the token owner!"
        );
...
contract ERC721Metadata is ERC721Enumerable, usingOraclize {
    ...
    function setTokenURI(uint256 tokenId) internal {
        ...
        string memory fullTokenURI = strConcat(_baseTokenURI, tokenIdStr);
